...
Storehouse.create(name: "Equinix", description: "Contact Us", address: "114 Rue Ambroise Croizat, 93200 Saint-Denis", capacity: 2300, day_price: 999, user_id: olivier.id)
Storehouse.create(name: "Illiad", description: "Contact Us", address: "29 Rue Edith Cavell, 94400 Vitry-sur-Seine", capacity: 1800, day_price: 759, user_id: benjamin.id)
Storehouse.create(name: "Une piece en plus", description: "Contact Us", address: "74 Rue Vieille du Temple, 75003 Paris", capacity: 3000, day_price: 54, user_id: adrien.id)
Storehouse.create(name: "Shurgard self storage", description: "Contact Us", address: "21-23 Rue Eugène Varlin, 75010 Paris", capacity: 20, day_price: 48, user_id: baptiste.id)
Storehouse.create(name: "DGM", description: "Contact Us", address: "26 Rue des Rigoles, 75020 Paris", capacity: 42, day_price: 67, user_id: olivier.id)
Storehouse.create(name: "Blondeau", description: "Contact Us", address: "14 Rue Parrot, 75012 Paris", capacity: 18, day_price: 32, user_id: benjamin.id)
Storehouse.create(name: "HomeBox", description: "Contact Us", address: "8 Place Boulnois, 75017 Paris", capacity: 65, day_price: 82, user_id: adrien.id)
